--  Add fields for the Signed checkbox in production_update
ALTER TABLE [dbo].[TblOrdersBOM_Items]
ADD [Signed] bit NULL
GO
ALTER TABLE [dbo].[TblOrdersBOM_Items]
ADD [Signed_Initials] text NULL
GO
ALTER TABLE [dbo].[TblOrdersBOM_Items]
ADD [Signed_Date] datetime NULL
GO
ALTER TABLE [dbo].[TblOrdersBOM_Items]
ADD [Signed_EmployeeID] bigint NULL
GO
...
IF EXISTS (SELECT o.id FROM sysobjects o INNER JOIN sysusers u ON o.uid = u.uid
    WHERE o.name = N'#TblOrdersBOM_Items4258' AND u.name = N'dbo')
BEGIN
  DROP TABLE [dbo].[#TblOrdersBOM_Items4258]
END
GO

CREATE TABLE [dbo].[#TblOrdersBOM_Items4258] (
...
INSERT INTO [dbo].[TblOrdersBOM_Items] ([OrderItemsID], [OrderID], [ProductID], [zzUnused_BOM_ID], [Quantity], [QuantityShipped], [Unit_of_Measure], [UnitPrice], [Discount], [Status], [Special_Instructions], [In_House_Notes], [Customer_Notes], [BackOrderCreated], [ProductName], [Product_Descripton], [Temp_ProductID], [Purchase_Price], [zzUnused_OldorderID], [zzUnused_OldOrderItemsID], [zzUnused_OldQuoteItemsID], [zzUnused_OldQuoteID], [UnitWeight], [ReadytoShip], [Prod_BoardFeet], [Prod_RipOperator], [Prod_Vendor], [Delivered], [DeliveredDate], [DropShipItem], [zzUnused_lumber_pack], [PRC], [zzUnused_Glue], [Final], [Prefinishing_Complete], [Signed], [PRC_Initials], [zzUnused_Glue_Initials], [Final_Initials], [Prefinishing_Complete_Initials], [Signed_Initials], [PRC_Date], [zzUnused_Glue_Date], [Final_Date], [Prefinishing_Complete_Date], [Signed_Date], [PRC_EmployeeID], [zzUnused_Glue_EmployeeID], [Final_EmployeeID], [Prefinishing_Complete_EmployeeID], [Signed_EmployeeID], [ExceptionOpened], [ExceptonDateCreated], [ExceptionDateClosed], [ExceptionCreateInitials], [ExceptionClosed], [ExceptionClosedInitials], [ExceptionDesription], [Outsource], [OutsourceDate], [OutsourceInitials], [exceptionOpened_EmployeeID], [ExceptionClosed_EmployeeID], [outsource_EmployeeID], [ExceptionId], [sort])
SELECT [OrderItemsID], [OrderID], [ProductID], [zzUnused_BOM_ID], [Quantity], [QuantityShipped], [Unit_of_Measure], [UnitPrice], [Discount], [Status], [Special_Instructions], [In_House_Notes], [Customer_Notes], [BackOrderCreated], [ProductName], [Product_Descripton], [Temp_ProductID], [Purchase_Price], [zzUnused_OldorderID], [zzUnused_OldOrderItemsID], [zzUnused_OldQuoteItemsID], [zzUnused_OldQuoteID], [UnitWeight], [ReadytoShip], [Prod_BoardFeet], [Prod_RipOperator], [Prod_Vendor], [Delivered], [DeliveredDate], [DropShipItem], [zzUnused_lumber_pack], [PRC], [zzUnused_Glue], [Final], [Prefinishing_Complete], [Signed], [PRC_Initials], [zzUnused_Glue_Initials], [Final_Initials], [Prefinishing_Complete_Initials], [Signed_Initials], [PRC_Date], [zzUnused_Glue_Date], [Final_Date], [Prefinishing_Complete_Date], [Signed_Date], [PRC_EmployeeID], [zzUnused_Glue_EmployeeID], [Final_EmployeeID], [Prefinishing_Complete_EmployeeID], [Signed_EmployeeID], [ExceptionOpened], [ExceptonDateCreated], [ExceptionDateClosed], [ExceptionCreateInitials], [ExceptionClosed], [ExceptionClosedInitials], [ExceptionDesription], [Outsource], [OutsourceDate], [OutsourceInitials], [exceptionOpened_EmployeeID], [ExceptionClosed_EmployeeID], [outsource_EmployeeID], [ExceptionId], [sort] FROM [dbo].[#TblOrdersBOM_Items4258]
GO
