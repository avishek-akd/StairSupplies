...
SELECT orderItemsId,
	    ...
	    OBOMI.UnitPrice * (1 - OBOMI.DiscountPercent) * Employees.SalesCommission AS costOfSalesCommision,
		...
		+ OBOMI.UnitPrice * (1 - OBOMI.DiscountPercent) * Employees.SalesCommission
		AS costPerUnit
