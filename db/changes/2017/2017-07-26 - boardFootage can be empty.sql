...
SELECT orderItemsId,
	    ...
	    OBOMI.OrderItemPricePerUnit * (1 - OBOMI.DiscountPercent) * Coalesce(Employees.SalesCommission, 0) AS costOfSalesCommision,
		...
		+ OBOMI.OrderItemPricePerUnit * (1 - OBOMI.DiscountPercent) * Coalesce(Employees.SalesCommission, 0)
		AS costPerUnit
